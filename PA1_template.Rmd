...
amean_new <- mean(aggsteps$steps)
amedian_new <- median(aggsteps$steps)

#Comparing Means
paste("New Mean      :", round(amean_new,2), "," ,  "     Original Mean :", amean)

#Comparing Medians
paste("New Median    :", round(amedian_new,2), ",", "   Original Median :", amedian)

```
The Mean and Median for Original and New Datasets are same.
